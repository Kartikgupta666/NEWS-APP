        ...
        <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
          <div className="col-md-4 d-flex align-items-center">
            <a href="/" className="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
              <i className="" style={{ 'font-size': '26px' }}>N.E.W.S</i>
            </a>
          ...
          <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
            ...
            <li className="ms-3"><a className="text-muted" target='_blank' href="https://www.youtube.com/channel/UCIKzs6MlFXQvgQbAAaH0GyA"><i className="fa fa-youtube-play" style={{ 'font-size': '26px' }}></i></a></li>
